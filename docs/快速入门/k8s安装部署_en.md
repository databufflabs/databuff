...
```bash
curl -fsSL https://databuff.ai/databuff/ai-apm-k8s-install.sh | bash -s -- --version 0.1.7
# or
APM_VERSION=0.1.7 curl -fsSL https://databuff.ai/databuff/ai-apm-k8s-install.sh | bash
```
