...
```bash
curl -fsSL https://databuff.ai/databuff/ai-apm-k8s-install.sh | bash -s -- --version 0.1.6
# 或
APM_VERSION=0.1.6 curl -fsSL https://databuff.ai/databuff/ai-apm-k8s-install.sh | bash
```
